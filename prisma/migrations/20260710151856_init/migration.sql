...
CREATE TABLE "User" (
    ...
    "freeSecondsLeft" INTEGER NOT NULL DEFAULT 600,
    "creditSeconds" INTEGER NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "CallSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
